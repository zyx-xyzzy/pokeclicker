...
// used to track modals visible states for laggy modal elements
const visibleModals = ko.observableArray();
...
$(document).on('show.bs.modal', '.modal', function (e) {
    ...
    visibleModals.push(this.id);
});

$(document).on('hidden.bs.modal', '.modal', function (e) {
    visibleModals.remove(this.id);
});
